"use strict";
var myName = "jeffery herd";
console.log("Name: " + myName.toUpperCase());
var myCareer = "Full Stack Developer";
console.log("Career: " + myCareer);
var description = "I'm only into computers so I can build The Iorn Giant";
...
function displayPosition(position, company, summary) {
